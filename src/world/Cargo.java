...
public class Cargo implements Serializable 
{
	...
	public int x;
	public static final int COAL = 1, IRON_ORE = 2, STONE = 3, LOG = 4, IRON = 5, MOTOR = 6, PROCESSOR = 7, RUBBER = 8, COPPER = 9, WIRE = 10, CABLE = 11, COIL = 12, COPPER_ORE = 13;
	...
	{
		if(c.ID == Cargo.IRON) return new Cargo(0,0,Cargo.IRON_ORE);
		if(c.ID == Cargo.COPPER) return new Cargo(0,0,Cargo.COPPER_ORE);
